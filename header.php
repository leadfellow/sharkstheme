        ...
        menuItems.forEach(function(item) {
            ...
            if (submenu) {
                ...
                items.forEach(function(li, index) {
                    ...
                    // Add HR separator after each item (except the last one)
                    if (index < items.length - 1) {
                        const separator = document.createElement('li');
                        separator.className = 'sharks-mega-menu__separator';
                        separator.innerHTML = `<svg width="946" height="153" viewBox="0 0 946 153" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                            <path d="M10.5352 22.8143L35 22.8143" stroke="black" stroke-width="2.8592" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M25.2148 13.0284L35.0008 22.8143L25.2148 32.6002" stroke="black" stroke-width="2.8592" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M61.066 38V9.44H65.77V23.132L78.076 9.44H83.788L70.978 23.468L84.208 38H78.076L65.77 24.518V38H61.066ZM96.7115 38.546C88.1855 38.546 82.9775 32.918 82.9775 23.762C82.9775 14.606 88.1855 8.894 96.7115 8.894C105.154 8.894 110.404 14.606 110.404 23.762C110.404 32.918 105.154 38.546 96.7115 38.546ZM96.7115 34.598C102.298 34.598 105.616 30.482 105.616 23.762C105.616 17 102.298 12.842 96.7115 12.842C91.1255 12.842 87.7655 17 87.7655 23.762C87.7655 30.482 91.1255 34.598 96.7115 34.598ZM113.427 38V9.44H123.213C132.159 9.44 137.703 14.816 137.703 23.762C137.703 32.708 132.159 38 123.213 38H113.427ZM123.213 34.178C129.303 34.178 132.915 30.314 132.915 23.762C132.915 17.126 129.303 13.262 123.213 13.262H118.131V34.178H123.213ZM163.75 27.122C163.75 34.22 159.298 38.546 152.116 38.546C144.934 38.546 140.482 34.22 140.482 27.122V9.44H145.186V27.122C145.186 31.91 147.79 34.766 152.116 34.766C156.484 34.766 159.046 31.868 159.046 27.122V9.44H163.75V27.122ZM167.428 38V9.44H172.132V34.178H185.95V38H167.428ZM188.173 38V9.44H207.871V13.22H192.877V21.368H206.275V25.106H192.877V34.22H207.871V38H188.173ZM210.601 38V9.44H215.305V21.41H229.165V9.44H233.869V38H229.165V25.232H215.305V38H210.601ZM245.595 38V13.388H236.061V9.44H259.791V13.388H250.299V38H245.595Z" fill="black"/>
                            <path d="M0 66H946" stroke="#BBBAB6"/>
                            <path d="M3.066 124V95.44H22.764V99.22H7.77V107.368H21.168V111.106H7.77V120.22H22.764V124H3.066ZM24.253 114.466V110.644H35.551V114.466H24.253ZM39.2254 124V95.44H49.3894C56.0674 95.44 60.1834 98.926 60.1834 104.638C60.1834 110.476 55.9834 113.878 49.4734 113.878H43.9294V124H39.2254ZM49.3474 99.22H43.9294V110.098H49.2214C53.1694 110.098 55.3534 107.998 55.3534 104.68C55.3534 101.362 53.1274 99.22 49.3474 99.22ZM75.4861 124.546C66.9601 124.546 61.7521 118.918 61.7521 109.762C61.7521 100.606 66.9601 94.894 75.4861 94.894C83.9281 94.894 89.1781 100.606 89.1781 109.762C89.1781 118.918 83.9281 124.546 75.4861 124.546ZM75.4861 120.598C81.0721 120.598 84.3901 116.482 84.3901 109.762C84.3901 103 81.0721 98.842 75.4861 98.842C69.9001 98.842 66.5401 103 66.5401 109.762C66.5401 116.482 69.9001 120.598 75.4861 120.598ZM104.927 124.546C96.4012 124.546 91.1932 118.918 91.1932 109.762C91.1932 100.606 96.4012 94.894 104.927 94.894C113.369 94.894 118.619 100.606 118.619 109.762C118.619 118.918 113.369 124.546 104.927 124.546ZM104.927 120.598C110.513 120.598 113.831 116.482 113.831 109.762C113.831 103 110.513 98.842 104.927 98.842C99.3412 98.842 95.9812 103 95.9812 109.762C95.9812 116.482 99.3412 120.598 104.927 120.598ZM121.642 124V95.44H131.428C140.374 95.44 145.918 100.816 145.918 109.762C145.918 118.708 140.374 124 131.428 124H121.642ZM131.428 120.178C137.518 120.178 141.13 116.314 141.13 109.762C141.13 103.126 137.518 99.262 131.428 99.262H126.346V120.178H131.428Z" fill="black"/>
                            <path d="M0 152H946" stroke="#BBBAB6"/>
                        </svg>`;
