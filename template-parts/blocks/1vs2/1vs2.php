...
// Icon library
function get_1vs2_icon($type) {
    $icons = [
        'x' => '<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M39.9969 2.00314C38.8906 0.896835 37.0969 0.896835 35.9906 2.00314L29.4969 8.49687C24.8042 13.1896 17.1958 13.1896 12.5031 8.49686L6.00941 2.00314C4.90311 0.896834 3.10944 0.896835 2.00314 2.00314C0.896835 3.10944 0.896835 4.90311 2.00314 6.00941L8.49687 12.5031C13.1896 17.1958 13.1896 24.8042 8.49686 29.4969L2.00314 35.9906C0.896834 37.0969 0.896835 38.8906 2.00314 39.9969C3.10944 41.1032 4.90311 41.1032 6.00941 39.9969L12.5031 33.5031C17.1958 28.8104 24.8042 28.8104 29.4969 33.5031L35.9906 39.9969C37.0969 41.1032 38.8906 41.1032 39.9969 39.9969C41.1032 38.8906 41.1032 37.0969 39.9969 35.9906L33.5031 29.4969C28.8104 24.8042 28.8104 17.1958 33.5031 12.5031L39.9969 6.00941C41.1032 4.90311 41.1032 3.10944 39.9969 2.00314Z" fill="currentColor"/></svg>',
        'star' => '<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20.8906 41.7803L14.917 27.6758L20.8896 30.3936L27.4229 27.4209L20.8906 41.7803ZM12.043 20.8896L14.917 27.6758L0 20.8896L14.6748 14.6738L12.043 20.8896ZM41.7793 20.8896L27.4229 27.4209L30.3945 20.8896L27.6768 14.917L41.7793 20.8896ZM27.6768 14.917L20.8896 12.043L14.6748 14.6738L20.8906 0L27.6768 14.917Z" fill="currentColor"/></svg>',
        'plus' => '<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26.0889 8.71533L31.7949 3.01025L38.9912 10.2065L33.2861 15.9106L41.3535 15.9116V26.0884H33.9561L39.377 31.1226L32.4512 38.5796L26.0889 32.6704V41.354H15.9121V33.2847L10.2061 38.9907L3.00977 31.7944L8.71582 26.0884H0.645508V15.9106H8.04297L2.62305 10.8774L9.54883 3.42041L15.9121 9.32959V0.645996H26.0889V8.71533Z" fill="currentColor"/></svg>'
    ];
    
    return isset($icons[$type]) ? $icons[$type] : $icons['x'];
}
                        ...
                        <div class="block-1vs2__card">
                            ...
                            <div class="block-1vs2__card-content">
                                ...
                                if (!empty($card['icon_type'])) {
                                    if ($card['icon_type'] === 'custom' && !empty($card['icon_custom'])) {
                                        $icon_html = $card['icon_custom'];
                                    } else {
                                        $icon_html = get_1vs2_icon($card['icon_type']);
                                    }
                                }
