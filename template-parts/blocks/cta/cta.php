      ...
      <?php if ($show_icon): ?>
        <div class="block-cta__icon">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 2L28 20L20 38L12 20L20 2Z" fill="currentColor"/>
            <path d="M2 20L20 12L38 20L20 28L2 20Z" fill="currentColor"/>
          </svg>
        </div>
      <?php endif; ?>
