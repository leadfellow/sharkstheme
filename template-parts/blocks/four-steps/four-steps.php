...
// Icon mapping for header (black stroke icons)
$header_icon_map = [
    ...
    'asterisk' => '<svg viewBox="0 0 62 62" fill="none"><path d="M31 0V62M62 31H0M52.3269 9.67313L9.67313 52.3269M52.3269 52.3269L9.67313 9.67313" stroke="black" stroke-width="2.06667"/></svg>',
    ...
    'circle' => '<svg viewBox="0 0 62 62" fill="none"><circle cx="31" cy="31" r="30" stroke="black" stroke-width="2"/></svg>',
];
