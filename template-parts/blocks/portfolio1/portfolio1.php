            ...
            <div class="portfolio1-items">
                ...
                ?>
                    ...
                    >
                        ...
                        <!-- Scrollable Image Section with iMac Mockup -->
                            ...
                            <div class="portfolio1-image-section">
                                <div class="portfolio1-image-wrapper">
                                    <div class="portfolio1-image-container" data-item-id="<?php echo esc_attr($item_id); ?>">
                                        <!-- iMac Frame -->
                                        <div class="portfolio1-imac-frame">
                                            <!-- Screen Bezel -->
                                            ...
                                            <!-- Apple Logo -->
                                            <div class="portfolio1-apple-logo">
                                        ...
                                        <!-- iMac Stand -->
                                        <div class="portfolio1-imac-stand">
                                            <div class="portfolio1-stand-neck"></div>
                                            <div class="portfolio1-stand-base"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
